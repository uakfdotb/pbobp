...
function service_list($constraints = array(), $arguments = array()) {
	$select = "SELECT pbobp_services.id AS service_id, pbobp_services.user_id, pbobp_services.product_id, pbobp_services.name, pbobp_services.creation_date, pbobp_services.recurring_date, pbobp_services.recurring_duration, pbobp_services.recurring_amount, pbobp_services.status, pbobp_services.currency_id, pbobp_users.email, pbobp_products.name AS product_name, pbobp_products.interface AS interface, pbobp_currencies.suffix AS currency_suffix, pbobp_currencies.prefix AS currency_prefix FROM pbobp_services LEFT JOIN pbobp_users ON pbobp_users.id = pbobp_services.user_id LEFT JOIN pbobp_products ON pbobp_products.id = pbobp_services.product_id LEFT JOIN pbobp_currencies ON pbobp_currencies.id = pbobp_services.currency_id";
