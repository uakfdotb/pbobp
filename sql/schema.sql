...
CREATE TABLE pbobp_invoices_lines (id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, invoice_id INT NOT NULL, amount FLOAT NOT NULL DEFAULT 0, service_id INT DEFAULT NULL, description VARCHAR(128) NOT NULL DEFAULT '');

CREATE TABLE pbobp_transactions (id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, invoice_id INT NOT NULL, user_id INT NOT NULL, gateway VARCHAR(64) NOT NULL, gateway_identifier VARCHAR(256) NOT NULL DEFAULT '', notes VARCHAR(256) NOT NULL DEFAULT '', amount FLOAT NOT NULL, amount_out FLOAT NOT NULL DEFAULT 0, currency_id INT NOT NULL, time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP);
...
-- this is a list of tokens for the remember me function
CREATE TABLE pbobp_auth_tokens (id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, token VARCHAR(128) NOT NULL, user_id INT NOT NULL, time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP);
